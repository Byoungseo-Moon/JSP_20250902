	...
	<%
	 ...
	 %> 
		...
		<form name="board" action="Board-Edit-Result.jsp">	
		  <input name="boradNO" value="<%= rs.getString("BOARDNO")%>" hidden)>	
		  ...
		  <table>
		  	...
		  	<tr>
		  		<th>작성자</th>
		  		<td ><input type="text" name="title" class="input-txt" value="<%= rs.getString("USERID") %>"></td>	  		
		  	<tr>
		  ...
		  <div>
		  	...
		  	<input type="button" value="수정완료" onclick="fnEdit()">
		  </div>
